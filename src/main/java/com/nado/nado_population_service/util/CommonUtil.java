...
public class CommonUtil {
	...
	static {
		String[] templates = new String[]{
				"type@=chatmsg/rid@=58839/ct@=8/uid@=123456/nn@=test/txt@=666/cid@=1111/ic@=icon/sahf@=0/level@=1/nl@=0/col@=0/dlv@=0/dc@=0/bdlv@=0/bnn@=test/bl@=0/brid@=58839/hc@=0/ol@=0/hl@=0/ifs@=0/el@=eid@AA=1@ASetp@AA=1@ASsc@AA=1@AS/",
